...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/load-game.css">
        ...
        <header id="header">
            ...
            <nav id="navbar">
                <ul>
                    ...
                    <li><a href="community-home.html">Community</a></li>
    ...
    <script>
        window.addEventListener('load', (event) => {
            ...
            xhttp.open('POST', '../controller/view-games-home.php', true);
        ...
        function searchGames() {
            ...
            xhttp.open('POST', '../controller/search-games-home.php', true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
